...
import com.roguegame.Reference;
import com.roguegame.utils.Tile;
import com.roguegame.utils.ResourceManager;
...
public class Floor {
	...
	public Floor(int floorNumber) {
		...
		ArrayList<String> strs = ResourceManager.readFloorFile("resources/floors/floor"+floorNumber+".txt");
